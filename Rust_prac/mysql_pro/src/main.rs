...
fn insert(student: Student){
    let pool = my::Pool::new("mysql://root:@localhost:3307/test").unwrap();    
...
// fn main (){
//     //collecting user data as mention in struct
//     println!("Enter id: ");
...
//     //struct call
//     let student = Student{id:id, name:Some(name), email:Some(email), age:age};
//     insert(student);
// //    fetch();
// }
